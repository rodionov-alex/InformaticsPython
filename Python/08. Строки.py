...
# По  сути функции index() и find() делают одно и то же. Единственное их отличие в том, что в случае если подстрока
# не найдена, то функция find() вернет индекс -1, а функция index() сгенерирует исключение: substring not found.
print()
# Замена подстроки
